...
export default function EsitlikKomitesiPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <p className="text-slate-700 mb-8 leading-relaxed">
        Eşitlik Komitesi, toplumsal cinsiyet eşitliği, fırsat eşitliği ve kapsayıcı
        yaklaşımları yaygınlaştırmayı amaçlayan bir programdır.
      </p>
